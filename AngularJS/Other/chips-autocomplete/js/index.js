...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $mdTheming, $window,
  ...
  function clearValue () {
    ...
    // Per https://www.w3schools.com/jsref/event_oninput.asp
...
function Application() {
  ...
  $ctrl.items = [
    { name:'Apples', description: 'long text describing the apples'},
    { name:'Bananas', description: 'long text describing the bananas'},
    { name:'Mangos', description: 'long text describing the mangos'},
    { name:'Grapes', description: 'long text describing the grapes'},

  ];

  $ctrl.selectedItems = [$ctrl.items[0]];
}